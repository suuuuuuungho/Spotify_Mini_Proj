...
export default function Discover() {
  ...
  return (
    <div className="relative flex flex-col gap-lg">
      <div className="relative overflow-hidden flex flex-col gap-lg rounded-[28px] p-lg max-w-4xl bg-surface-container-high/0 backdrop-blur-xl border border-t-white/50 border-x-white/15 border-b-black/40 shadow-[0_24px_64px_rgba(0,0,0,0.55),0_8px_20px_rgba(0,0,0,0.4),inset_0_2px_0_rgba(255,255,255,0.4),inset_0_-24px_32px_-20px_rgba(0,0,0,0.65)]">
        <div className="pointer-events-none absolute -top-20 left-10 w-56 h-24 rounded-full bg-white/35 blur-2xl" />
        <div className="pointer-events-none absolute -bottom-20 -right-20 w-56 h-56 rounded-full bg-black/35 blur-2xl" />
        <div className="pointer-events-none absolute top-1/3 -left-16 w-32 h-32 rounded-full bg-primary/15 blur-2xl" />

        <div className="relative">
          <h1 className="-mt-[12px] font-vibe text-[90px] leading-[0.95] font-black tracking-[-0.02em] text-on-surface">
            Vibe Finder
          </h1>
        ...
        <div className="relative grid sm:grid-cols-3 gap-md">
